...
import { z } from 'zod';
import { AchiClient, AchiApiError } from './client.js';
// ── Configuration ───────────────────────────────────────────────────────────
...
// ── Mutations ───────────────────────────────────────────────────────────────
server.tool('upload_file', 'Upload a small file from text or base64. Do not base64 multi-GB files — use upload_file_from_path.', {
...
server.tool('upload_file_from_path', 'Upload a local file (including multi-GB zips) via 5 MB chunks. Cloudflare rejects a single POST over ~100 MB.', {
