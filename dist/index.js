...
// ── Mutations ───────────────────────────────────────────────────────────────
server.tool('upload_file', 'Upload a new file. Provide content as base64 (for binaries) or text. Set mimeType for proper handling.', {
...
server.tool('list_unit_payments', 'Bank-statement payment trail for an apartment (cold/warm/NK). Source of rent-paid truth.', {
    unitId: z.string().uuid(),
